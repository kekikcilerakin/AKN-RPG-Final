using UnityEngine;
 ...
 public class LineRendererArrow : MonoBehaviour
 {
     ...
     public void UpdateArrow()
     {
        ...
        cachedLineRenderer.startColor = startColor;
        cachedLineRenderer.endColor = endColor;
        cachedLineRenderer.SetPositions(new Vector3[] {
            ArrowOrigin
            , Vector3.Lerp(ArrowOrigin, ArrowTarget, 0.999f)
            , Vector3.Lerp(ArrowOrigin, ArrowTarget, 1)
            , ArrowTarget });
        cachedLineRenderer.startWidth = Camera.main.orthographicSize * 0.1f;
        cachedLineRenderer.endWidth = Camera.main.orthographicSize * 0.001f;
