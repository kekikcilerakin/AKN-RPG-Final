...
public class PanAndZoom : MonoBehaviour {
    ...
    public float boundMinX = -157;
    public float boundMaxX = 157;
    public float boundMinY = -157;
    public float boundMaxY = 157;
    ...
    void OnPinch(Vector2 center, float oldDistance, float newDistance, Vector2 touchDelta) {
        ...
        {
            AKN_GameController.instance.playerController.playerMapIcon.transform.localScale = new Vector3(Camera.main.orthographicSize * 0.025f, Camera.main.orthographicSize * 0.025f);
            AKN_GameController.instance.playerController.travelConfirmation.transform.localScale = new Vector3(Camera.main.orthographicSize * 0.1f, Camera.main.orthographicSize * 0.1f);
        }
        ...
        if (controlCamera && cameraControlEnabled) {
            ...
            if (cam.orthographic) {
                ...
                cam.orthographicSize = Mathf.Clamp(cam.orthographicSize * oldDistance / newDistance, zoomMin, zoomMax);
